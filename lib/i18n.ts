...
export const translations = {
  pt: {
    ...
    brand: {
      ...
      description: 'Aluguer de viaturas premium em Maputo e principais cidades de Moçambique, com suporte 24/7.',
    },
    // Navigation
    nav: {
      fleet: 'Frota',
    ...
    fleet: {
      title: 'Nossa Frota',
      subtitle: 'Escolha entre a nossa seleção de veículos premium disponíveis em Maputo, Beira e Nampula',
      economy: 'Económico',
      economyDesc: 'Perfeito para deslocações urbanas em Maputo',
      economyFeatures: ['3 Lugares', 'Automático', 'Motor 1.2L', 'Económico em combustível'],
      standard: 'Standard',
      ...
      suvFeatures: ['5 Lugares', 'Automático', 'Tracção 4x4', 'Ar Condicionado'],
      premium: 'Premium',
    ...
    pricing: {
      ...
      subtitle: 'Pacotes flexíveis em Metical (MT) para todas as necessidades, sem taxas escondidas',
      daily: '24 Horas',
    ...
    faq: {
      ...
      notFoundSubtitle: 'A nossa equipa de apoio ao cliente está disponível 24/7 para ajudar',
      contactSupport: 'Contactar Suporte',
    },
    // Footer
    footer: {
      about: 'Sobre',
      aboutText: 'Aluguer de viaturas premium em Moçambique, com frota moderna e suporte 24/7.',
  ...
  en: {
    ...
    brand: {
      ...
      description: 'Premium car rental in Maputo and Mozambique\'s main cities, with 24/7 support.',
    },
    // Navigation
    nav: {
      fleet: 'Fleet',
    ...
    fleet: {
      title: 'Our Fleet',
      subtitle: 'Choose from our selection of premium vehicles available in Maputo, Beira and Nampula',
      economy: 'Economy',
      economyDesc: 'Perfect for city trips in Maputo',
      economyFeatures: ['3 Seats', 'Automatic', '1.2L Engine', 'Fuel Efficient'],
      standard: 'Standard',
    ...
    pricing: {
      ...
      subtitle: 'Flexible packages in Metical (MT) for all needs, no hidden fees',
      daily: '24 Hours',
    ...
    faq: {
      ...
      notFoundSubtitle: 'Our customer support team is available 24/7 to help you',
      contactSupport: 'Contact Support',
    },
    // Footer
    footer: {
      about: 'About',
      aboutText: 'Premium car rental in Mozambique, with a modern fleet and 24/7 support.',
