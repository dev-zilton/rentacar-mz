      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="border-t border-gray-800 pt-8 flex items-center justify-between flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.instagram.com/transporteslogisticakk/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-blue-400 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/258843792635" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-400 hover:text-blue-400 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
